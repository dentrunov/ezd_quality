#средние оценки для одного класса
import requests, time, sys, json, codecs
...
response = session.get('https://dnevnik.mos.ru/reports/api/final_marks/json?academic_year_id=9&class_unit_id=404323&in_string=subjects&pid=29396719&with_deleted=false')
